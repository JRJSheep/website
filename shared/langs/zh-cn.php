...
$s['latestTestingOnlyWarn'] = '<b>此页面仅供测试目的。</b> 此页面检索到的内部版本未被后端服务器处理，因此将仅提供替代包，并且可能只有不完整的检索结果。 如果要下载已知的内部版本，请使用已知内部版本的下载页面。';
...
$s['noAdditionalEditions'] = '此选项下没有其他版本可用。';
$s['learnMore'] = '了解更多';
...
$s['learnMoreUpdates2'] = '如果在任何其他系统上运行转换脚本，则更新将不会集成到生成的镜像中。';
