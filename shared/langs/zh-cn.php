...
$s['noLangsAvailable'] = '此内部版本没有可用的语言。';
$s['browseFiles'] = '浏览文件';
...
$s['additionalEditionsInfo'] = '如果你有需要，可在右侧表格中找到其他版本，请选择指定的所需版本，然后单击<i>下一步</i>。在摘要页面上，你可以在适当的下载选项下选择所需的其他版本。';
...
$s['fileRenamingScriptDesc1'] = '下方的脚本可用于快速重命名下载的文件。';
...
$s['error_NO_BUILDS_IN_FILEINFO'] = '<i>fileinfo</i> 数据库不包含任何内部版本。';
$s['error_SEARCH_NO_RESULTS'] = '无法找到可执行查询的项目。';
...
$s['error_ILLEGAL_MINOR'] = '指定的修订内部版本不正确。';
...
$s['error_NOT_FOUND'] = '无法找到指定的选择。';
$s['error_MISSING_FILES'] = '指定的 UUP 集缺少文件。';
